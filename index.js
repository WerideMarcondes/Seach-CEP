...
var seach_Cep = function () { return __awaiter(_this, void 0, void 0, function () {
    var cep, url, dados, address, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                address = _a.sent();
                result = document.getElementById("address").innerHTML = "Neighborhood: " + address.bairro + "\n"
                    + "State: " + address.uf + "\n"
...
var erro_cep = function () {
    var cep = document.getElementById("cep").value;
    var cont = 9;
    var resto = cont - cep.length;
